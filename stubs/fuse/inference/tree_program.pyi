...
class TreeFactorGraph:
    ...
    def build_program(
        self, *, query_vars: Sequence[str], evidence: dict[str, Any] | None = None
    ) -> TreeProgram: ...

def conditional_probability(
    outputs: dict[str, Any], query_vars: Sequence[str], assignment: dict[str, int]
) -> float: ...
def brute_force_joint(
    factors: Sequence[Factor], variables: Sequence[Variable], evidence: dict[str, int] | None = None
) -> NDArray[Any]: ...
