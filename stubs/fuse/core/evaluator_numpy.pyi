...
class _StreamRingStore:
    ...
    origin: Incomplete
    max_pos: Incomplete
    ring_to_value: dict[tuple[int, ...], NDArray[Any]]
    ...
    def store(self, key: tuple[int, ...], value: NDArray[Any], *, update_max: bool) -> None: ...
    def get(self, key: tuple[int, ...]) -> NDArray[Any] | None: ...
    def latest(self, positions: dict[str, int]) -> NDArray[Any] | None: ...
