...
def compile(
    ...
    **_,
    ...
    if cfg.mode == "demand":
        raise ValueError("JAX backend does not yet support demand-driven execution mode")
    if cfg.projection_strategy == "monte_carlo":
        raise ValueError("JAX backend does not yet support Monte Carlo projection strategy")
